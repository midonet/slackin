  ...
  let div = dom('.splash',
    ...
    dom('form',
      ...
      dom('input.form-item type=email placeholder=you@yourdomain.com '
        + 'onkeyup="document.querySelector(\'a.button\').href='
        + '\'https://midonet.slack.com/?email=\'+this.value" '
        + (!iframe ? 'autofocus' : '')),
    ...
    //!iframe && dom('p.signin',
      ...
      //'.'
    //),
    dom('a.button href=https://midonet.slack.com/ target='
      + (iframe ? '_blank' : '_top'), 'Login'),
    !iframe && dom('footer',
      'powered by ',
...
function style({ logo, active, iframe } = {}){
  ...
  css.add('button, .form-item, a.button', {
    'font-size': '12px',
